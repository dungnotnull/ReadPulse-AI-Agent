...
| 10 | Passage leveling: public domain texts, grade assigned offline by Flesch Reading Ease and cross-checked against published grade bands; readability score and source shown with each passage | `src/lib/scoring/readability.ts`, passage store | Flesch 1948 |
